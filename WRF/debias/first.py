...
def file_clean(file_list, var_WRF, var_gMET, output_directory):
    ...
    if args.vname == 'T2':
        ...
        output_dir_max = f'{output_directory/tmmx/'
        os.makedirs(output_dir_max, exist_ok = True) # Don't make if it already exists
        output_dir_min = f'{output_directory}/tmmn/'
